                  ...
                  <div className=' font-normal'>
                      ...
                      <div className='font-medium'>
                        <Link href={'#'}>
                          <a className='hover:text-amber-500' onClick={()=>sendEmail()}>
                            <div className=''>cloudrider.m92@gmail.com</div>                
                          </a>
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className='pt-2'>
                      ...
                      <div className='font-medium w-[300px] md:w-[400px] flex justify-between items-center'>
                        <Link href={'https://github.com/LawrenceWoronoff'}>
                          <a target={'_blank'} className='hover:text-amber-500'>
                            <FaGithub/>
                          </a>
                        </Link>
                        <Link href={'https://t.me/goldentechstar'}>
                          <a target={'_blank'} className='hover:text-amber-500'>
                            <FaTelegram/>
                          </a>
                        </Link>
                        <Link href={'https://join.skype.com/invite/a0DSmXB5f8JM'}>
                          <a target={'_blank'} className='hover:text-amber-500'>
                            <FaSkype/>
                          </a>
                        </Link>
